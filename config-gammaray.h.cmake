...
#define GAMMARAY_BIN_INSTALL_DIR "${BIN_INSTALL_DIR}" ${INTDIR}

#define GAMMARAY_PLUGIN_VERSION "${GAMMARAY_PLUGIN_VERSION}"

#cmakedefine GAMMARAY_PROBE_ABI "${GAMMARAY_PROBE_ABI}"
#cmakedefine GAMMARAY_PROBE_ABI_DEBUG "${GAMMARAY_PROBE_ABI_DEBUG}"
#cmakedefine GAMMARAY_PROBE_ABI_RELEASE "${GAMMARAY_PROBE_ABI_RELEASE}"

// relative inverse install dirs
#define GAMMARAY_INVERSE_BIN_DIR "${GAMMARAY_INVERSE_BIN_DIR}" "${INVERSE_INTDIR}"
#define GAMMARAY_INVERSE_PROBE_DIR "${GAMMARAY_INVERSE_PROBE_DIR}"
#define GAMMARAY_INVERSE_LIBEXEC_DIR "${GAMMARAY_INVERSE_LIBEXEC_DIR}" "${INVERSE_INTDIR}"
