...
if(MSVC)
  if(MSVC_IDE)
    set(GAMMARAY_PROBE_ABI_RELEASE "${GAMMARAY_PROBE_ABI}-release")
    set(GAMMARAY_PROBE_ABI_DEBUG   "${GAMMARAY_PROBE_ABI}-debug")
    set(GAMMARAY_PROBE_ABI)
  else()
...
if(WIN32)
  ...
  if(MSVC_IDE)
    set(GAMMARAY_PROBE_ABI_RELEASE "${GAMMARAY_PROBE_ABI_RELEASE}-${abisize}")
    set(GAMMARAY_PROBE_ABI_DEBUG "${GAMMARAY_PROBE_ABI_DEBUG}-${abisize}")
  else()
    set(GAMMARAY_PROBE_ABI "${GAMMARAY_PROBE_ABI}-${abisize}")
  endif()
...
if(MSVC_IDE)
  message(STATUS "Building probe for ABI: ${GAMMARAY_PROBE_ABI_DEBUG}")
  message(STATUS "Building probe for ABI: ${GAMMARAY_PROBE_ABI_RELEASE}")
else()
